// OpenTelemetry instrumentation setup for Node.js server
...
// Async function to setup OpenTelemetry
async function setupOpenTelemetry() {
  // Dynamically import resources to avoid verbatimModuleSyntax issues
...
// Initialize and export OpenTelemetry setup
const sdkPromise = setupOpenTelemetry();

export { setupOpenTelemetry };
export default sdkPromise;