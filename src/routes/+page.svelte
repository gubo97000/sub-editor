<script>
	...
	import SubtitleContainer from '../lib/subtitle-container.svelte';
...
<div class="container">
	...
	<div style="position:sticky; top:0; height: 100vh; display:flex; flex-direction: column;">
		...
		<details open={true}>
			...
			<div>
				<input type="file" bind:files={directory} webkitdirectory />
				<select bind:value={gs.selectedVideo}>
					{#each Object.entries(videoLib) as [key, video]}
